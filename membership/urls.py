...
urlpatterns = [
    ...
    path ("why-we-are-unique/", views.WhyWeAreUniqueView.as_view(), name="why-we-are-unique"),
    path ("why-we-are-unique/<int:id>", views.WhyWeAreUniqueDetailView.as_view(), name="why-we-are-unique-details"),
    path("our-members", views.OurMembersView.as_view() ,name="our-members"),
    path("our-members/<int:id>", views.OurMembersDetialView.as_view(),name="our-members-details"),
    ...
    path("why-we-are-unique/public", views.WhyWeAreUniquePublicView.as_view(), name="why-we-are-unique-public"),
    path("our-members/public", views.OurMembersPublicView.as_view() ,name="our-members-public")
]
