...
trusted_origins = os.getenv("TRUSTED_ALLOWED_ORIGINS_HOST", "").strip()

# Ensure it's not empty before splitting
if trusted_origins:
...
# Using Cloudinary for Image Storage DEFAULT_FILE_STORAGE has been set above.
# MEDIA_URL = "/media/"
